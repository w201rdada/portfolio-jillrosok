...
readLines('https://www.zotero.org/api/users/4667740/items/top?start=0&limit=null&format=bibtex&itemKey=P2P2FJB5&key=izM2jxajrcTZ6AKwwZC45jOv&v=1') %>% writeLines('references.bib')

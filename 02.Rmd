...
By its nature, this project will have naive beginnings; potentially first determining the color palate of a poem using the results of an xkcd color survey to determine the relation between specific colors defined using hexidecimal values and the words in a poem using word vectors (https://blog.xkcd.com/2010/05/03/color-survey-results/). These naive beginnings can then be built upon to intersect with something like “random art” which takes a word and generates a corresponding picture using a mathematical formual that is not intended to align with the meaning of the words (http://www.random-art.org/about/). 
